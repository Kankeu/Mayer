...
// module
exports.push([module.i, "\n.md-column[data-v-34b7d2fa] {\n  margin-bottom: 13px;\n  margin-top: 13px;\n}\n.attrArticle[data-v-34b7d2fa] {\n  font-family: monospace;\n}\n.images[data-v-34b7d2fa] {\n  width: 300px;\n  height: 300px;\n}\n.spinner[data-v-34b7d2fa] {\n  left: 47%;\n}\n.grille[data-v-34b7d2fa] {\n  justify-content: space-between;\n}\nsmall[data-v-34b7d2fa] {\n  font-family: monospace;\n}\n.article[data-v-34b7d2fa] {\n  margin-bottom: 30px;\n}\n.md-card-content[data-v-34b7d2fa] {\n  display: grid;\n}\n.md-card-content p[data-v-34b7d2fa] {\n  max-height: 100px;\n  overflow-y: auto;\n  word-wrap: break-word;\n}\n.position-box[data-v-34b7d2fa] {\n  overflow: hidden;\n}\n.attrArticle[data-v-34b7d2fa] {\n  font-size: 13px;\n  display: flex;\n  justify-content: space-between;\n}\n.md-theme-default.md-card .md-card-actions .check:not(.md-primary):not(.md-warn):not(.md-accent) .md-icon[data-v-34b7d2fa] {\n  color: #FD3A13;\n}\n.md-theme-default.md-card .md-card-actions .cmtCheck:not(.md-primary):not(.md-warn):not(.md-accent) .md-icon[data-v-34b7d2fa] {\n  color: turquoise;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_1__plugins_ArticlesMixin__["a" /* default */].Boutique('/articles/user{/id}')],
    data: function data() {
        return {
            article: null
        };
    ...
    methods: {
        openDialog: function openDialog(ref, article) {
            if (!article.dimension) {
                var dimension = { x: 30, y: 100 };
                this.$set(article, 'dimension', dimension);
            }
        ...
        dimensionner: function dimensionner() {
            console.log(this.article.dimension);
            ...
            _vm._l(_vm.articles, function(article, index) {
              return _c(
                "md-layout",
                {
                  ...
                  attrs: {
                    "md-flex": article.dimension ? article.dimension.x : 30,
                    "md-column": "",
                    "md-flex-xsmall": "100",
                    "md-flex-medium":
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("md-card-header", [
                        ...
                        _vm._v(" "),
                        _c("div", [_vm._v(_vm._s(article.prix))]),
                        _vm._v(" "),
